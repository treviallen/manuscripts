...
# parse sites
##########################################################################################
csvfile = '/nas/active/ops/community_safety/ehp/georisk_earthquake/modelling/sandpits/tallen/NSHA2018/shared/nsha18_map_sites.csv'
...
x, y = m(locs[:,0], locs[:,1])
m.plot(x, y, 'ko',markersize=2, label='Gridded Sites')
plt.legend(loc=3, numpoints=1)


plt.savefig('map_gridded_sites.png', format='png', bbox_inches='tight', dpi=200)
plt.show()
