...
if getcwd().startswith('/nas'):
    ...
    shpfile1  = '/nas/active/ops/community_safety/ehp/georisk_earthquake/modelling/sandpits/tallen/NSHA2018/source_models/zones/2018_mw/NSHA13_Background/shapefiles/NSHA13_BACKGROUND_NSHA18_MFD.shp'
    shpfile2  = '/nas/active/ops/community_safety/ehp/georisk_earthquake/modelling/sandpits/tallen/NSHA2018/source_models/zones/2018_mw/Domains_multi_mc/shapefiles/Domains_NSHA18_MFD.shp'
...
###############################################################################
# parse data
src_code, src_bval, src_n0, src_class, sf = parse_shp_attributes(shpfile1)
...
src_code, src_bval, src_n0, src_class, sf = parse_shp_attributes(shpfile2)
...
# label polygons
labelpolygon(m2, plt, sf, 'CODE', value='OSGB', col='w', fweight='normal', fsize=14, addOutline=False)
labelpolygon(m2, plt, sf, 'CODE', value='GAWL', col='w', fweight='normal', fsize=14, addOutline=False)
labelpolygon(m2, plt, sf, 'CODE', value='FMLR', col='w', fweight='normal', fsize=14, addOutline=False)
...
# save figure
plt.savefig('map_b_val.png', fmt='png', bbox_inches='tight')
