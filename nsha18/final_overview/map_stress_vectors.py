...
for x, y, sh in zip(xm, ym, shmax):
    ...
    ax.arrow(x-dx, y-dy, dx, dy, head_width=30000, head_length=head_length, lw = 0.3, fc='0.2', fill=True, length_includes_head = True)
...
plt.savefig('map_stress_vectors.png', format='png', bbox_inches='tight', dpi=200)
plt.show()
