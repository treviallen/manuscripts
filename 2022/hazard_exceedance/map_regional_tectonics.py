...
# label polygons
x, y = m(135, -17.5)
plt.text(x, y, 'North Australian\nCraton', size=12, c='maroon', ha='center', va='top', weight='normal', style='italic', path_effects=path_effects)

x, y = m(126, -14.5)
plt.text(x, y, 'Kimberly\nCraton', size=12, c='maroon', ha='center', va='top', weight='normal', style='italic', path_effects=path_effects)

x, y = m(126, -12.5)
plt.text(x, y, 'Western\nExtended Crust', size=12, c='g', ha='center', weight='normal', style='italic', path_effects=path_effects)

x, y = m(130, -24.5)
plt.text(x, y, 'Central Australia Reactivated\nProterozoic Crust', size=12, c='orangered', \
         va='center', ha='center', weight='normal', style='italic', path_effects=path_effects)

x, y = m(145.5, -24)
plt.text(x, y, 'Tasmanides', size=12, c='b', ha='center', weight='normal', style='italic', path_effects=path_effects)

x, y = m(129, -5)
plt.text(x, y, 'Banda Sea', size=12, c='k', ha='center', va='center', weight='normal', style='italic', path_effects=path_effects)
