...
'''
au_parser = get_iris_stn_dataless_seed('AU')
s_parser = get_iris_stn_dataless_seed('S')
iu_parser = get_iris_stn_dataless_seed('IU')
...
for p, pf in enumerate(pickfiles[0:]):
    ...
    if fileStat.st_size < 1300000000L:
        ...
        for tr in new_st:
            ...
            # only use z-component
            if tr.stats.channel.endswith('Z') and not tr.stats.channel[1] == ('P'):
                
                if tr.stats.location=='00' or tr.stats.location=='':
                    ...
                    try:
                        ...
                        if addRecDat == True:
                            ...
                            sttr = tr.stats.starttime + pickDat['sidx'] * tr.stats.delta - 1.# 0.98 # allow buffer
                            ettr = tr.stats.starttime + pickDat['rgidx'] * tr.stats.delta + 1.# 1.02 # allow buffer
                            ...
                            sttr = tr.stats.starttime + pickDat['pidx'] * tr.stats.delta - 1. #* 0.98 # allow buffer
                            ettr = tr.stats.starttime + pickDat['rgidx'] * tr.stats.delta + 1. #* 1.02 # allow buffer
