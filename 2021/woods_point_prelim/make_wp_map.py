...
clat = [-37.814, -42.882, -35.282, -33.87]
clon = [144.964, 147.324, 149.129, 151.21]
cloc = ['Melbourne', 'Hobart', 'Canberra', 'Sydney']
x, y = m(clon, clat)
...
folder = '/Users/trev/Documents/Earthquake_Data/20210921.WoodsPoint/psa'
stns = []
for root, dirnames, filenames in walk(folder):
    for filename in filenames:
        if filename.endswith('.psa'):
...
plt.savefig('wp_sta_map.png', format='png', bbox_inches='tight', dpi=300)
plt.show()
