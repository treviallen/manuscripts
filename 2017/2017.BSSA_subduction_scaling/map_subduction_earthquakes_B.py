...
plt.savefig('subduction_events_B.pdf', format='pdf', dpi=300, bbox_inches='tight')
plt.savefig('subduction_events_B.png', format='png', dpi=300, bbox_inches='tight')
plt.show()