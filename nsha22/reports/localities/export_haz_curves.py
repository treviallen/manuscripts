...
periods = ['PGA', 'SA(0.1)', 'SA(0.15)', 'SA(0.2)', 'SA(0.3)', 'SA(0.4)', 'SA(0.5)', 'SA(0.7)', 'SA(1.0)', \
           'SA(1.35)', 'SA(1.5)', 'SA(1.75)', 'SA(2.0)', 'SA(3.0)', 'SA(1.0)']
...
for period in periods:
    ...
    if getcwd().startswith('/nas'):
        hazcurvefile = '/nas/active/ops/community_safety/ehp/georisk_earthquake/modelling/sandpits/tallen/NSHA2023/source_models/complete_model/final/results_fractilesUHS/hazard_curve-mean-'+period+'_1.csv'
        sitelistfile = '/nas/active/ops/community_safety/ehp/georisk_earthquake/modelling/sandpits/tallen/NSHA2023/shared/nsha_cities.csv'
    else:
        hazcurvefile = '/Users/trev/Documents/Geoscience_Australia/NSHA2023/source_models/complete_model/2023_final/results_uhs_fractiles_SC_'+site_class+'/hazard_curve-mean-'+period+'_1.csv'
        sitelistfile = '/Users/trev/Documents/Geoscience_Australia/NSHA2023/shared/nsha_cities.csv'
    ...
    # set output file
    outcsv = path.join('annual_haz_curves', '_'.join(('nsha23_haz_curves', period, 'SC', site_class+'.csv')))
