...
ncfiles = ['/Users/trev/Documents/Manuscripts/manuscripts/2022/hazard_exceedance/haz_maps/gshap/gshap_interp.0.05.grd']
#ncfiles = ['haz_maps/gaull90/gaull90_interp.0.05.grd']
           
pltlett = ['', 'b)', 'c)', 'd)', 'e)']
modnames = ['GSHAP (1999)', 'NSHM12', 'NSHA18']
##############################################################################
...
cax = figure.add_axes([0.2,0.11,0.6,0.02]) # setup colorbar axes.
...
# set title
titlestr = 'Mean PGA for 10% in 50-Years (g)'
...
'''    
# now save png file
plt.savefig(path.join('maps/as1170_1993_gshap_map.png'), dpi=300, format='png', bbox_inches='tight')
