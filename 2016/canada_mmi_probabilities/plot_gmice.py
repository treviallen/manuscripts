...
from mmi_tools import mmi2pgm_wald99, mmi2pgm_worden12, mmi2pgm_atkinson07, mmi2pgm_dangkua11_ena, mmi2pgm_caprio15
...
plt.semilogx(ak07pga, mmis, '-', color='green', lw=2.)
...
plt.legend(['Wea99', 'AK07', 'DC11 (ENA)', 'Wea12', 'Cea15 (Global)'], loc=2, fontsize=11)
ticks = range(2,10)
...
plt.semilogx(ak07pgv, mmis, '-', color='green',lw=2.)
