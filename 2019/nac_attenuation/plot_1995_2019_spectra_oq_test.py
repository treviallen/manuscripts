...
def makesubplt(i, fig, plt, sta, sps, mag, dep, ztor, dip, rake, rhyp, vs30, datestr):
    ...
    # test OQ implememtation
    A22imt = allen2022_gsim(mag, dep, rhyp, vs30)
    ...
    if colTrue == 'True':
        ...
        plt.loglog(A22imt['per'], exp(A22imt['sa']),'-.' , lw=2., color=cs[1])
    ...
    if i == 1:
        ...
        plt.legend(['Manual', 'OpenQuake', 'Geometric Mean'],loc=4, fontsize=10)
...
from calc_oq_gmpes import get_station_vs30, allen2022_gsim
