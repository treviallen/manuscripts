...
region = argv[1] # either "au" or "ceus"
...
modnames = ['NSHA18 GMMs', 'CEUS GMMs']
##############################################################################
...
cax = figure.add_axes([0.213,0.04,0.6,0.04]) # setup colorbar axes.
...
# set title
titlestr = '1970-2019 Observed PGA (g)'
...
'''    
# now save png file
plt.savefig(path.join('composite_shakemap_'+region+'.png'), dpi=300, format='png', bbox_inches='tight')
