...
# add earthquakes
##########################################################################################
elons = [120.2946854, 146.3478699, 117.0213]
elats = [-18.26223373, -37.49168396, -33.3494]
ename = ['M6.6 Offshore\nBroome', 'M5.9 Woods Point', 'M4.5 Arthur River']
x,y = m(elons, elats)
plt.plot(x, y, '*', markerfacecolor='r', markeredgecolor='w', markeredgewidth=.5, markersize=12)
path_effects=[PathEffects.withStroke(linewidth=1.75, foreground="w")]
e = 0
for elo, ela in zip(x, y):
    plt.text(elo+30000, ela+10000, ename[e], size=9, c='k', va='bottom', ha='left', weight='light', \
             style='normal', rotation=0 , path_effects=path_effects)
    e += 1
...
plt.savefig('tectonic_setting.png',fmt='png',dpi=600,bbox_inches='tight')
