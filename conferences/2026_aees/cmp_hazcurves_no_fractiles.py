...
if __name__ == "__main__":
    ...
    for p, pp in enumerate(plt_places):
        ...
        for as1170 in as1170dict:
            if as1170['city'] == pp:
                plt.loglog(max([as1170['as1170'], 0.08]), 1/500., 'o', ms=7, c=cols[j+2], mec=cols[j+1], label='AS1170.4-2024')
