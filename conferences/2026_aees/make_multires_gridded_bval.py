'''
shapefiles generated by /NSHA2023/source_models/zones/get_NSHA18_mfds_gridded_b.py
'''
...
for deg in degs:
    ...
    shppath = path.join(basepath, 'Hex_'+deg+'D', 'shapefiles', 'Hex_'+deg+'D_NSHA23.shp')
    ...
    for i in range(0, len(bvals)):
        ...
        for shape, shp_b, shp_bl in zip(shapes, shp_bvals, shp_bvals_low):
