...
interp_freqs = logspace(-1.5,2)[:-7] # from 0.03-30 Hz
...
#shutil.copy('fft_hvsr_data.pkl', 'fft_hvsr_data.pkl.hold')
...
pklfile = open('fft_hvsr_data.pkl', 'wb')
