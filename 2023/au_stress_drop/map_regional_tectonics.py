...
sf = shapefile.Reader(shpfile)
drawshapepoly(m, plt, sf, edgecolor='r', alpha=1, zorder=100)
...
# label polygons
x, y = m(135, -18)
plt.text(x, y, 'North Australian\nCraton', size=11, c='maroon', ha='center', va='top', weight='normal', style='italic', path_effects=path_effects, zorder=200)

x, y = m(126, -14.5)
plt.text(x, y, 'Kimberly\nCraton', size=11, c='maroon', ha='center', va='top', weight='normal', style='italic', path_effects=path_effects, zorder=200)

x, y = m(118.75, -21.5)
plt.text(x, y, 'Pilbara\nCraton', size=11, c='maroon', ha='center', va='center', weight='normal', style='italic', path_effects=path_effects, zorder=200)
...
x, y = m(126, -12.5)
plt.text(x, y, 'Western\nExtended Crust', size=11, c='g', ha='center', weight='normal', style='italic', path_effects=path_effects, zorder=200)

x, y = m(148, -39.5)
plt.text(x, y, 'Eastern\nExtended Crust', size=11, c='g', ha='center', va='center', weight='normal', style='italic', path_effects=path_effects, zorder=200)

x, y = m(130, -24.5)
plt.text(x, y, 'Central Australia Reactivated\nProterozoic Crust', size=11, c='orangered', \
         va='center', ha='center', weight='normal', style='italic', path_effects=path_effects, zorder=200)

x, y = m(146.5, -28)
plt.text(x, y, 'Tasmanides', size=11, c='b', ha='center', weight='normal', style='italic', path_effects=path_effects, zorder=200)

x, y = m(138.75, -32)
plt.text(x, y, 'Flinders\nRanges', size=10, c='purple', ha='center', va='center', weight='normal', \
         rotation=90, path_effects=path_effects, zorder=200)


x, y = m(129, -5)
plt.text(x, y, 'Banda Sea', size=11, c='k', ha='center', va='center', weight='normal', style='italic', path_effects=path_effects, zorder=200)

# add faults

x, y = m(129, -9.8)
plt.text(x, y, 'Timor Trough', size=10, c='k', va='center', ha='center', weight='normal', \
         rotation=10 , path_effects=path_effects, zorder=200)
         
x, y = m(117, -11.9)
plt.text(x, y, 'Sunda Arc', size=10, c='k', va='center', ha='center', weight='normal', \
         rotation=-0.5 , path_effects=path_effects, zorder=200)
...
plt.text(x, y, 'New Guinea\nHighlands', size=10, c='k', va='center', ha='center', weight='normal', \
         rotation=-0 , path_effects=path_effects, zorder=200)
