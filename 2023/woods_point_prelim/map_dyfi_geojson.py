...
m = Basemap(projection='merc',\
            ...
            rsphere=6371200.,resolution=res,area_thresh=200)
...
x, y = m(eqlo, eqla)
plt.plot(x, y, '*', markersize=25, markerfacecolor='None', mec='r', mew=1.5, zorder=1000000)

# annotate cities
numCities = 21
annotate_cities(numCities, plt, m, markersize=5)
...
plt.text(x, y, plttxt, size=16, ha='left', va='top', bbox=props, zorder=1000000)
