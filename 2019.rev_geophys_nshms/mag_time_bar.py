...
hmtk_csv = '/Users/tallen/Documents/Geoscience_Australia/NSHA2018/catalogue/data//NSHA18CAT_V0.2_hmtk_declustered.csv'
...
for minmag in minmags:
    ...
    for pm in pltmean:
        ...
        leg1 = ax.legend([bar1[0]], ['Original $\mathregular{M_{L}}$'])
        ...
        if pm == True:
            ...
            plt.plot([1959.65, 1988.35], [av_n_1960_1988, av_n_1960_1988], '--', c='darkblue', lw=2.5, label='Original $\mathregular{M_{L}}$ Average Annual Number')
